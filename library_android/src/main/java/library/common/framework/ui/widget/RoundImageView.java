 ...
 *
 * @author zhuhf
 * @version [AndroidLibrary, 202--09-15]
 */
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderOverlay = a.getBoolean(R.styleable.com_RoundImageView_com_border_overlay, DEFAULT_BORDER_OVERLAY);
        mFillColor = a.getColor(R.styleable.com_RoundImageView_com_fill_color, DEFAULT_FILL_COLOR);
        roundRadius = a.getDimensionPixelSize(R.styleable.com_RoundImageView_com_round_corner, APKUtils.dip2px(context, 12));
        a.recycle();
