...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private TextView createTitleTV() {
        ...
        tv.setMaxWidth(getScreenWidth(mContext) - getResources().getDimensionPixelSize(R.dimen.dp60) * 2);
        tv.setSingleLine();
        tv.setGravity(Gravity.CENTER);
        tv.setMaxLines(1);
        tv.setEllipsize(TextUtils.TruncateAt.END);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.dp16));
    ...
    private TextView createTV(boolean isLeft) {
        ...
        tv.setGravity(Gravity.CENTER);
        tv.setEllipsize(TextUtils.TruncateAt.END);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.dp12));
